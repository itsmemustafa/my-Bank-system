...
#include "ClsUser.h"
using namespace std;
class ShowUpdateUserScreen:public clsScreen
{private:
    ...
    public :
        static void ShowUpdateUser()
        {
            ...
            cout << "\n\n";
            _ReadUserInfo(c);
            clsUser::enSaveResults saversult;
            saversult = c.Save();
            switch (saversult)
            {
            case clsUser::svFaildEmptyObject:
                cout << "faild to update , user info is empty \n";
                break;
            case clsUser::svSucceeded:
                cout << "user updating successus :)\n";
                _PrintUser(c);
                  break;
            case clsUser::svFaildUserExists:
                cout << "faild to update cant find the user :( \n";
                break;
            default:
                break;
            }
